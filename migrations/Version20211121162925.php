 ...
 */
final class Version20211121162925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE request CHANGE user_id created_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE request CHANGE created_by_id user_id INT DEFAULT NULL');
